...
namespace slick.Domain.Interfaces
{
    public interface IGeneric<TEntity> where TEntity : class
    {
        ...
        Task<TEntity?> GetLastInsertedAsync(CancellationToken cancellationToken = default);
        ...
        Task<List<TEntity>> GetTrashedAsync(Expression<Func<TEntity, bool>> filter, CancellationToken cancellationToken = default, params Expression<Func<TEntity, object>>[] includes);
        ...
        Task<int> UpdateWithNavigationAsync(TEntity entity, Action<TEntity>? navigationUpdates = null, CancellationToken cancellationToken = default);
    }
}
